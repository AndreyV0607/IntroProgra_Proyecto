...
public class Parqueo {
    ...
    public void menuParqueo(){
        ...
        while(!salir){
            //Menú del parqueo 
            String parqueomenu = JOptionPane.showInputDialog("Parqueo - Menú\n"
                    + "1. Reservar un espacio\n"
                    + "2. Liberar un espacio\n"
                    + "3. Salir\n");
            if (parqueomenu == null) break;
